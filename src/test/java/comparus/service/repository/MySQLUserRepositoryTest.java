...
public class MySQLUserRepositoryTest {
    ...
    @Autowired
    public MySQLUserRepositoryTest(UserRepository userRepository) {
    ...
    @Container
    private static final MySQLContainer db = new MySQLContainer<>(DockerImageName.parse("mysql:5.7.34"));
